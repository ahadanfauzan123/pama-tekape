...
function Footer() {
  return (
      <div className="bg-gray-800 mt-[240px] px-8 pt-16 mx-auto w-screen md:px-24 lg:px-8">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          ...
          >
            <Image alt="lambang" src={Logo} width={900} height={900} className='w-[24px] h-[24px]' />
            <span className="ml-2 text-xl font-bold tracking-wide text-gray-300 uppercase">
              PANCA ARMADA ANDALAN
            </span>
          </a>
