  ...
  return (
      ...
      <div className=" w-full min-h-[80vh] lg:h-[70vh] flex flex-col space-y-8 lg:space-y-0 items-center justify-center">
        ...
        className="flex w-full flex-col items-center justify-center space-y-12">
          <h1 className="w-[80%] mx-auto text-center text-6xl font-extrabold text-gray-600 "><span className="text-red-600">PACA ARMADA ANDALAN</span></h1>
...
standar kualitas tertinggi.
            ...
            <div className="w-full mt-[80px] flex items-center justify-center space-x-[120px] py-5 bg-gray-800 text-white">
